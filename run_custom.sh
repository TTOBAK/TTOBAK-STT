...
for part in train_data_01 test_data_01 custom; do
...
steps/make_mfcc.sh --cmd "$train_cmd" --nj 1 data/custom exp/make_mfcc/custom $mfccdir
steps/compute_cmvn_stats.sh data/custom exp/make_mfcc/custom $mfccdir

# ... and then combine data sets into one (for later extension)
utils/combine_data.sh \
  data/train_clean data/train_data_01 data/custom
